...
include "components/app.php"; ?>
    ...
    <div class="product-detail-container">
        <!-- Back Button -->
        <a class="back-btn" onclick="history.back()" href="home.html">
        ...
        <div class="product-hero">
            ...
            <div class="product-image-container">
                <img src="../img/14.jpg" alt="CyberTech Pro X Headset" class="main-product-image" id="mainProductImage">
                <div class="thumbnail-container">
                    <img src="../img/15.jpg" alt="Thumbnail 1" class="product-thumbnail active"
                        onclick="changeMainImage(this, '../img/15.jpg')">
                    <img src="../img/16.jpg" alt="Thumbnail 2" class="product-thumbnail"
                        onclick="changeMainImage(this, '../img/16.jpg')">
                    <img src="../img/17.avif" alt="Thumbnail 3" class="product-thumbnail"
                        onclick="changeMainImage(this, '../img/17.avif')">
                </div>
            </div>
